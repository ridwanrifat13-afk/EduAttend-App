...
export default function LandingPage() {
  ...
  const handleAndroidInstall = async () => {
    if (deferredPrompt) {
      ...
      alert(
        "Installation is not supported by your browser or the app is already installed.",
      );
    }
  };
  ...
  return (
    <div className="min-h-screen bg-brand-50 font-sans selection:bg-brand-900 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl tracking-tight text-brand-900 font-serif">
                EduAttend
              </span>
            </div>
            <div className="flex items-center gap-4">
              <Link
                to="/auth"
                className="text-sm font-bold text-brand-900/70 hover:text-brand-900 transition-colors hidden sm:block"
              >
                Sign In
              </Link>
              <Link
                to="/auth"
                className="px-4 py-2 bg-brand-900 text-brand-50 rounded-xl font-bold text-sm hover:scale-105 transition-transform shadow-lg shadow-brand-900/20"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-brand-900/60 font-medium mb-12">
            Most school apps stop working when Wi-Fi drops. Yours doesn’t.
            Teachers can record attendance offline, and the system automatically
            syncs when connection returns.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/auth"
              className="w-full sm:w-auto px-8 py-4 bg-brand-900 text-brand-50 rounded-2xl font-bold hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-900/20 transition-all flex items-center justify-center gap-2"
            >
              Start Free Trial <ArrowRight size={20} />
            </Link>
            <a
              href="#how-to-install"
              className="w-full sm:w-auto px-8 py-4 bg-white border border-brand-200 text-brand-900 rounded-2xl font-bold hover:bg-brand-100 transition-all flex items-center justify-center gap-2 shadow-sm"
            >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-extrabold tracking-tight text-brand-900 mb-4">
              Why Schools Choose EduAttend
            </h2>
            <p className="text-brand-900/60 font-medium text-lg">
              Focus on students, not on software. Everything you need to manage
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="col-span-1 md:col-span-2 bg-brand-50 rounded-3xl p-8 md:p-12 border border-brand-100">
              ...
              <p className="text-brand-900/60 text-lg font-medium leading-relaxed">
                No installation. No technical setup. No complicated systems.
                Admins create a school, share an invite code, and teachers join
                instantly.
              </p>
            </div>
            <div className="col-span-1 bg-brand-900 text-brand-50 rounded-3xl p-8 border border-brand-800">
              ...
              <p className="text-brand-50/70 font-medium leading-relaxed text-sm">
                When a teacher marks a student absent, the admin dashboard
                updates immediately. Know what's happening in every classroom.
              </p>
            </div>
            <div className="col-span-1 bg-white border border-brand-200 rounded-3xl p-8 shadow-sm">
              ...
              <p className="text-brand-900/60 font-medium text-sm">
                No paper registers. No spreadsheets. Turn 30 minutes of
                paperwork into 30 seconds.
              </p>
            </div>
            <div className="col-span-1 md:col-span-2 bg-gradient-to-br from-brand-100 to-white border border-brand-200 rounded-3xl p-8 shadow-sm flex items-center justify-between overflow-hidden relative">
              <div className="relative z-10 w-full md:w-3/4">
                ...
                <p className="text-brand-900/60 font-medium">
                  Automatic analytics highlight frequent absences, attendance
                  trends, and at-risk students before they become serious.
                </p>
              </div>
            </div>
            <div className="col-span-1 md:col-span-2 bg-white border border-brand-200 rounded-3xl p-8 shadow-sm relative overflow-hidden">
              ...
              <p className="text-brand-900/60 font-medium">
                All attendance records are stored securely in the cloud and
                backed up automatically. No lost registers. No damaged data.
              </p>
            </div>
      ...
      <section id="how-to-install" className="py-24 bg-brand-900 text-brand-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-8">
            Install Like an App — Without the App Store
          </h2>
          <p className="text-brand-50/70 font-medium text-lg mb-16 max-w-2xl mx-auto">
            Teachers install directly from their browser to their phone's home
            screen. No downloads. No updates. No delays. Works on any device.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            ...
            >
              <svg
                ...
                className="w-6 h-6"
              >
                <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 24 184.8 8 277.3c-19 111.4 39 216 79.4 216 28 0 45.4-19 79.4-19 33.3 0 49 18.7 79.6 18.7 41.5 0 65.6-59.5 83.4-105.7-41-16.7-59.5-62.7-59.5-103.6zM187 132c25.4 0 54.4-23.7 60-64.1-23.7 3.3-64.4 25.1-79 64.1z" />
              </svg>
              Install on iOS
            </button>
          </div>
      ...
      <section id="pricing" className="py-24 bg-brand-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-brand-900/60 font-medium text-lg">
              Choose the perfect plan for your school's size. Start free,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-[2rem] p-8 md:p-10 border-2 border-transparent shadow-xl shadow-brand-900/5 flex flex-col relative overflow-hidden transition-all hover:-translate-y-1">
              <div className="mb-8">
                ...
                <p className="text-brand-900/60 font-medium text-sm">
                  Perfect for small classes and solo teachers testing the
                  waters.
                </p>
              </div>
              ...
              <ul className="space-y-4 mb-10 flex-1">
                {[
                  ...
                  "Standard Admin View",
                  "Standard Teacher Dashboard",
                ].map((feature, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 font-medium text-brand-900/80"
                  >
              ...
              <Link
                to="/auth?plan=free"
                className="w-full py-4 px-6 rounded-xl font-bold bg-brand-100 text-brand-900 text-center hover:bg-brand-200 transition-colors"
              >
                Get Started Free
              </Link>
            </div>
            ...
            <div className="bg-brand-900 rounded-[2rem] p-8 md:p-10 shadow-2xl relative flex flex-col transition-all hover:-translate-y-1 overflow-hidden">
              ...
              <div className="mb-8 relative z-10">
                ...
                <p className="text-brand-100/70 font-medium text-sm">
                  For growing institutions that need advanced features and
                  scale.
                </p>
              </div>
              <div className="mb-8 flex items-baseline gap-2 relative z-10">
                <span className="text-5xl font-extrabold text-white">$10</span>
                <span className="text-brand-100/50 font-bold">
                  /mo per school
                </span>
              </div>
              <ul className="space-y-4 mb-10 flex-1 relative z-10">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 font-medium text-brand-50/90"
                  >
      ...
      <footer className="py-12 bg-white border-t border-brand-100 text-center">
        ...
        <p className="text-brand-900/40 font-medium text-sm">
          © {new Date().getFullYear()} EduAttend. Built as an offline-first PWA.
        </p>
      </footer>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full relative shadow-2xl animate-fade-in">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-brand-900/60 font-medium mt-2 text-sm">
                Add EduAttend to your home screen for the full offline
                experience.
              </p>
            </div>
            ...
            <ol className="space-y-4 font-medium text-brand-900/80 mb-8">
              <li className="flex items-center gap-4 bg-brand-50 p-3 rounded-xl border border-brand-100">
                <span className="bg-brand-900 text-white w-7 h-7 rounded-full flex items-center justify-center text-sm flex-shrink-0 font-bold shadow-md">
                  1
                </span>
                <span>
